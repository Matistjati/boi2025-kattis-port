...
\begin{tikzpicture}
\begin{scope}
\foreach \i\l in {0/5, 1/3, 2/0, 3/2, 4/1, 5/4} {
\node[circle, draw, fill=white] (n\i) at ({60 * \i}:2) {\l};
}
\foreach \i in {0,...,4} {
\draw (n\i) -- (n\the\numexpr\i+1\relax);
}
\draw (n5) -- (n0);
\draw[very thick] (n2) -- (n3) -- (n4) -- (n2);
\end{scope}
